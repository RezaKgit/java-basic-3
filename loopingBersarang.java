...
public class loopingBersarang {
    ...
    static void cetakNama() {
        ...
        System.out.println(ANSI_CYAN + "Author : Reza Kurniawan" + ANSI_RESET);
        System.out.println(ANSI_CYAN + "Github : [https://github.com/RezaKgit]" + ANSI_RESET);
        System.out.println(ANSI_CYAN + "Instagram : [https://www.instagram.com/rezakurniawan122020/]" + ANSI_RESET);
        System.out.println(ANSI_PURPLE + "============================================================" + ANSI_RESET);
    }
}